            ...
            <div className="admin-settings-panel admin-tabbed-panel">
              ...
              <div className="admin-tab-content">
                {activeTab === "tasks" && (<div>
                  ...
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "flex-end", marginBottom: 6 }}>
                    <div style={{ flex: "1 1 150px" }}><label className="create-field-label">Start (UTC)</label><input id="ct-start" type="datetime-local" defaultValue={dayjs.utc().format("YYYY-MM-DDTHH:mm")} className="create-field-input" onChange={(e) => { const endEl = document.getElementById("ct-end"); if (endEl && e.target.value && endEl.value && endEl.value < e.target.value) endEl.value = e.target.value; if (endEl) endEl.min = e.target.value; }} /></div>
                    <div style={{ flex: "1 1 150px" }}><label className="create-field-label">End (UTC)</label><input id="ct-end" type="datetime-local" defaultValue={dayjs.utc().add(2, "hour").format("YYYY-MM-DDTHH:mm")} className="create-field-input" onChange={(e) => { const startEl = document.getElementById("ct-start"); if (startEl && e.target.value && e.target.value < startEl.value) { e.target.value = startEl.value; } }} /></div>
                ...
                {activeTab === "events" && (<div>
                  ...
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "flex-end", marginBottom: 6 }}>
                    <div style={{ flex: "1 1 150px" }}><label className="create-field-label">Start (UTC)</label><input id="ce-start" type="datetime-local" defaultValue={dayjs.utc().format("YYYY-MM-DDTHH:mm")} className="create-field-input" onChange={(e) => { const endEl = document.getElementById("ce-end"); if (endEl && e.target.value && endEl.value < e.target.value) endEl.value = e.target.value; }} /></div>
                    <div style={{ flex: "1 1 150px" }}><label className="create-field-label">End (UTC)</label><input id="ce-end" type="datetime-local" defaultValue={dayjs.utc().add(1, "hour").format("YYYY-MM-DDTHH:mm")} className="create-field-input" onChange={(e) => { const startEl = document.getElementById("ce-start"); if (startEl && e.target.value && e.target.value < startEl.value) { e.target.value = startEl.value; } }} /></div>
